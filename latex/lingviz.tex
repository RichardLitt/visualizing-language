...
%
%%%%%I can't find the above reference. We should make explicit that we're modelling them all together at once, which I still don't think has been done. 
